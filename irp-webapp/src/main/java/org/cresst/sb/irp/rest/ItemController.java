...
public class ItemController {
	...
	public Itemrelease.Item getItem(@PathVariable("id") String id) {
	...
	@ApiMethod(path = "/items/item/{id}/attribute", description = "Returns an item attribute", verb = ApiVerb.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.Attriblist getAttriblist(@PathVariable("id") String id) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.Attriblist.Attrib getAttribByIntAttid(@PathVariable("id") String id,
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.Attriblist.Attrib getAttribByStrAttid(@PathVariable("id") String id,
			@PathVariable("attid") String attid) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.Tutorial gettutorial(@PathVariable("id") String id) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.Resourceslist getResourceslist(@PathVariable("id") String id) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.MachineRubric getMachineRubric(@PathVariable("id") String id) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.RendererSpec getRendererSpec(@PathVariable("id") String id) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public List<Itemrelease.Item.Content> getContents(@PathVariable("id") String id) {
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public Itemrelease.Item.Content getContent(@PathVariable("id") String id, @PathVariable("language") String language){
		if (!NumberUtils.isNumber(id)) {
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	public List<Itemrelease.Item.KeywordList> getkeywordList(@PathVariable("id") String id){
		if (!NumberUtils.isNumber(id)) {
